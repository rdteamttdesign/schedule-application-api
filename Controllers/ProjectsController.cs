...
//  // Get project list and version hierarchy
//  [HttpGet()]
//  [Authorize]
...
//    {
//      VersionName = formData.ProjectName,
//      UserId = userId,
...
//    };
//    var result = await _projectService.CreateVersion( newProject );
...
//    existingProject.VersionName = formData.ProjectName;
...
//  {
//    var setting = await _projectSettingService.GetProjectSetting( projectId );
//    var stepworkColor = await _colorService.GetStepworkColorDefsByVersionId( projectId );
...
//      return BadRequest( ModelState.GetErrorMessages() );
//    }
//    var colors = await _colorService.GetStepworkColorDefsByVersionId( projectId );
...
//      var projectName = $"Copy of {project.VersionName}";
